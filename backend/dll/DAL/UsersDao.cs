    ...
    public class UsersDAO
    {
                        ...
                        "ORDER BY u.email;", connection))
                    {
                        using (SqlDataReader dataReader = command.ExecuteReader())
                        {
                            while (dataReader.Read())
                            {
                                ...
                                UserModel user = users.FirstOrDefault(u => u.UserId == userId);
                                ...
                                if (user == null)
                                {
                                    ...
                                    {
                                        user.CareerMap = new CareerMapModel()
                                        {
                                ...
                                AccessTypeModel accessType = new AccessTypeModel
                                {
        ...
        public UserModel SelectUser(int userId)
        {
            ...
            try
            {
                ...
                Console.WriteLine("The GetUser query was successful.");
                return user;
            }
            catch (SqlException ex)
            {
